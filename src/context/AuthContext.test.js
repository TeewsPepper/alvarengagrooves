...
describe('AuthContext', () => {
  ...
  test('register logs user data and does not change isAuthenticated', () => {
    console.log = jest.fn();
    renderWithAuthProvider(<TestComponent />);
  ...
  test('register can set isAuthenticated to true', () => {
    renderWithAuthProvider(<TestComponent />);
    ...
    // Aquí deberías agregar la lógica para autenticar al usuario después de registrarse en el contexto
    act(() => {
      screen.getByText('Login').click();
    });
  ...
  test('login when already authenticated', () => {
    ...
    // Intenta iniciar sesión de nuevo cuando ya está autenticado
    act(() => {
      screen.getByText('Login').click();
    });
  ...
  test('logout when not authenticated', () => {
    ...
    // Intenta cerrar sesión cuando no está autenticado
    act(() => {
      screen.getByText('Logout').click();
    });
